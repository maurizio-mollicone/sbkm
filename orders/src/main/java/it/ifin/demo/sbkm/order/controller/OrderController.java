package it.ifin.demo.sbkm.order.controller;
...
import it.ifin.demo.sbkm.order.service.OrderGeneratorService;
...
public class OrderController {
    ...
    public Order create(@RequestBody Order order) {
        ...
        template.send(Const.Topic.ORDERS, order.getId(), order);
        LOG.info("Sent: {}", order);
        return order;
    }
